...
#for subject in sub-CC110033 ; do
	...
	echo '------------------------------------ working on' ${subject} '-----------------------------------'
	 ...
	 sbatch --output=/lustre/archive/q10027/CamCAN_BackUp/logs/vol2surf/${subject}_vol2surf.log --nodes=1 --ntasks=1 --cpus-per-task=1 --time=00:40:00 --mem=4000 camcan_vol2surf.sh ${subject}
	else
